...
**SupportTriage-OpenEnv** is a high-fidelity simulation environment for training and evaluating AI agents in customer support triage. Developed as a modular and scalable solution for the **Meta PyTorch Hackathon**, it leverages the **OpenEnv**
